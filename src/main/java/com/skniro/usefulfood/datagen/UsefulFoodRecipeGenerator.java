...
public class UsefulFoodRecipeGenerator extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.MagicFruitSalad).input(Items.GLISTERING_MELON_SLICE).input(Items.BOWL).input(Items.GOLDEN_APPLE).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.BOWL)).offerTo(exporter);
