...
public class ModContent {
    ...
    public static void CreativeTab() {
        ItemGroupEvents.modifyEntriesEvent(UsefulFood.UsefulFood_Group).register(content -> {
            ...
            content.accept(UsefulFoodBlocks.GLASS_JAR);
            content.accept(UsefulFoodBlocks.Apple_JAM_JAR);
            content.accept(UsefulFoodBlocks.Melon_JAM_JAR);
            content.accept(UsefulFoodBlocks.Chorus_JAM_JAR);
            content.accept(UsefulFoodBlocks.Sweet_Berries_JAM_JAR);
            content.accept(UsefulFoodBlocks.Glow_Berries_JAM_JAR);
