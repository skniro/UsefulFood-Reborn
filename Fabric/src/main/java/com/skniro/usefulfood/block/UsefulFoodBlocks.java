...
public class UsefulFoodBlocks {
    ...
    public static final Block Apple_JAM_JAR = registerBlock("apple_jam_jar", (settings)-> new JamJarBlock(settings, UsefulFoodItems.AppleJam.getDefaultStack(), UsefulFoodBlocks.GLASS_JAR),(AbstractBlock.Settings.create().nonOpaque().strength(0.3F).sounds(BlockSoundGroup.GLASS)), UsefulFood.UsefulFood_Group);
    public static final Block Melon_JAM_JAR = registerBlock("melon_jam_jar", (settings)-> new JamJarBlock(settings, UsefulFoodItems.MelonJam.getDefaultStack(), UsefulFoodBlocks.GLASS_JAR),(AbstractBlock.Settings.create().nonOpaque().strength(0.3F).sounds(BlockSoundGroup.GLASS)), UsefulFood.UsefulFood_Group);
