...
public class ModLootTableModifiers {
    public static final ResourceLocation SQUID_ID = ResourceLocation.withDefaultNamespace("entities/squid");
    public static final ResourceLocation GLOW_SQUID_ID = ResourceLocation.withDefaultNamespace("entities/glow_squid");
