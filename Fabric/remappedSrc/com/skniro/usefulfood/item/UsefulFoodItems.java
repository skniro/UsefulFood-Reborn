...
public static final Item MilkBottle =
    ...
    private static final Map<ResourceLocation, List<ItemLike>> itemsByGroup = new LinkedHashMap<>();

    private static Item registerItem(String name, Item item) {
        return Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(UsefulFood.MOD_ID, name), item);
    }
