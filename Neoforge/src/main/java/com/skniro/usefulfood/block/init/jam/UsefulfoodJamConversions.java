...
public class UsefulfoodJamConversions {
    ...
    public static void registerJamConversion(JamType jamType, Supplier<Item> emptyItemSupplier, Supplier<Item> jammedItemSupplier) {
        BiMap<Item, Item> conversions = JamJarBlock.JAM_TYPE_MAPS.computeIfAbsent(jamType, t -> HashBiMap.create());
        conversions.put(emptyItemSupplier.get(), jammedItemSupplier.get());
    }
