...
public class UsefulFoodRecipeGenerator extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.ChocolateCandy).input(Items.COCOA_BEANS).input(MyTagGenerator.Milk).input(Items.SUGAR).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.MILK_BUCKET)).offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.FruitSalad).input(Items.APPLE).input(Items.MELON_SLICE).input(Items.BOWL).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.MELON_SLICE)).offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.MagicFruitSalad).input(Items.GLISTERING_MELON_SLICE).input(Items.BOWL).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.BOWL)).input(Items.GOLDEN_APPLE);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.SugarCube).input(Items.SUGAR,4).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.SUGAR)).offerTo(exporter);
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.Marshmallow).input(Items.SUGAR,3).input(Items.BOWL).input(Items.WATER_BUCKET).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.BOWL)).offerTo(exporter);
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.Fishwich).input(UsefulFoodItems.BreadSlice,2).input(MyTagGenerator.Fish).criterion("has_base_item", RecipeProvider.conditionsFromItem(UsefulFoodItems.BreadSlice)).offerTo(exporter);
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.Trailmix).input(Items.BOWL).input(Items.MELON_SEEDS).input(Items.PUMPKIN_SEEDS).input(Items.WHEAT_SEEDS).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.BOWL)).offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodBlocks.AppleCake).input(Items.APPLE,2).input(Items.WHEAT,3).input(Ingredient.fromTag(MyTagGenerator.Milk),3).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.APPLE)).offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodBlocks.ChocolateCake).input(Items.COCOA_BEANS,2).input(Items.WHEAT,3).input(Ingredient.fromTag(MyTagGenerator.Milk),3).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.WHEAT)).offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodBlocks.MagicCake).input(Items.ENCHANTED_GOLDEN_APPLE,2).input(Items.WHEAT,3).input(Ingredient.fromTag(MyTagGenerator.Milk),3).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.WHEAT)).offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodBlocks.CaramelCake).input(UsefulFoodItems.caramel,2).input(Items.WHEAT,3).input(Ingredient.fromTag(MyTagGenerator.Milk),3).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.WHEAT)).offerTo(exporter);
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.Sushi).input(MyTagGenerator.Fish).input(Items.LILY_PAD).criterion("has_base_item",RecipeProvider.conditionsFromItem(Items.LILY_PAD)).offerTo(exporter);
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.FishnChips).input(MyTagGenerator.Fish).input(UsefulFoodItems.FrenchFries).criterion("has_base_item", RecipeProvider.conditionsFromItem(UsefulFoodItems.FrenchFries)).offerTo(exporter);
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.FishSoup).input(Items.CARROT).input(Items.BOWL).input(Items.POTATO).input(MyTagGenerator.Fish).criterion("has_base_item", RecipeProvider.conditionsFromItem(Items.POTATO)).offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.Tea).input(Items.GLASS_BOTTLE).input(Items.LILY_PAD).criterion("has_base_item",RecipeProvider.conditionsFromItem(Items.LILY_PAD)).offerTo(exporter);
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD,UsefulFoodItems.PanCakeDough).input(Items.SUGAR).input(Items.WHEAT).input(Items.EGG).input(MyTagGenerator.Milk).criterion("has_base_item",RecipeProvider.conditionsFromItem(Items.SUGAR)).offerTo(exporter);
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(Items.EGG), RecipeCategory.FOOD,UsefulFoodItems.FriedEgg, 0.45F, 300).criterion("has_base_item", RecipeProvider.conditionsFromItem(UsefulFoodItems.SugarCube)).offerTo(exporter);
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(UsefulFoodItems.Marshmallow), RecipeCategory.FOOD,UsefulFoodItems.CookMarshmallow, 0.45F, 300).criterion("has_base_item", RecipeProvider.conditionsFromItem(UsefulFoodItems.Marshmallow)).offerTo(exporter);
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(UsefulFoodItems.SquidTentacleRaw), RecipeCategory.FOOD,UsefulFoodItems.SquidTentacleCooked, 0.45F, 300).criterion("has_base_item", RecipeProvider.conditionsFromItem(UsefulFoodItems.SquidTentacleRaw)).offerTo(exporter);
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(UsefulFoodItems.ChocolateMilkBottle),RecipeCategory.FOOD, UsefulFoodItems.hotchocolatebottle, 0.45F, 300).criterion("has_base_item", RecipeProvider.conditionsFromItem(UsefulFoodItems.ChocolateMilkBottle)).offerTo(exporter);
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(UsefulFoodItems.MilkBottle), RecipeCategory.FOOD,UsefulFoodItems.HotMilkBottle, 0.45F, 300).criterion("has_base_item", RecipeProvider.conditionsFromItem(UsefulFoodItems.MilkBottle)).offerTo(exporter);
