...
public class CandleMagicCakeBlock extends AbstractCandleBlock {
    ...
    public static final MapCodec<CandleMagicCakeBlock> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(Registries.BLOCK.getCodec().fieldOf("candle").forGetter((block) -> {
            return block.candle;
        }), createSettingsCodec()).apply(instance, CandleMagicCakeBlock::new);
    });
    ...
    public CandleMagicCakeBlock(Block candle, Settings settings) {
        super(settings);
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ActionResult actionResult = SpecialCakeBlockState.tryEat(world, pos, UsefulFoodCakeBlocks.MagicCake.getDefaultState(), player);
    ...
    @Override
    protected MapCodec<? extends CandleMagicCakeBlock> getCodec() {
        return CODEC;
    }
