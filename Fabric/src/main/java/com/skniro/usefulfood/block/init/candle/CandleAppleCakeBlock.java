...
public class CandleAppleCakeBlock extends AbstractCandleBlock {
    ...
    public static final MapCodec<CandleAppleCakeBlock> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(Registries.BLOCK.getCodec().fieldOf("candle").forGetter((block) -> {
            return block.candle;
        }), createSettingsCodec()).apply(instance, CandleAppleCakeBlock::new);
    });
    ...
    public CandleAppleCakeBlock(Block candle, Settings settings) {
        super(settings);
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ActionResult actionResult = SpecialCakeBlockState.tryEat(world, pos, UsefulFoodCakeBlocks.AppleCake.getDefaultState(), player);
    ...
    @Override
    protected MapCodec<? extends CandleAppleCakeBlock> getCodec() {
        return CODEC;
    }
