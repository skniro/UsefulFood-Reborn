...
import com.skniro.usefulfood.item.init.MilkItemBottle;
...
public static final RegistryObject<Item> MilkBottle =
        registerItem("milkbottle",()-> new MilkItemBottle(
                new Item
                .Properties()
                .food
                        (new Food
    ...
    public static final RegistryObject<Item> FruitSalad =
            registerItem("fruitsalad", ()->new SoupItem(
                    new Item
                            .Properties()
                            .food
                                    (new Food
    ...
    public static final RegistryObject<Item> MagicFruitSalad = registerItem("magicfruitsalad", ()->new SoupItem(
            new Item
                    .Properties()
                    .food
                            (new Food
    ...
    // 1.4
    public static final RegistryObject<Item> MagicIceCream = registerItem("magicicecream", ()->new SoupItem(
            new Item
                    .Properties()
                    .food
                            (new Food
