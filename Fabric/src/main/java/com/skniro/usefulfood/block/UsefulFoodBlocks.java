...
public class UsefulFoodBlocks {
    ...
    //Chocolate cake
    public static final Block ChocolateCake = registerBlock("chocolatecake",new ChocolateCakeBlockState(FabricBlockSettings.copy(Blocks.CAKE),12,0.5F), UsefulFood.UsefulFood_Group);
    ...
    // 1.4
    //Caramel cake
    public static final Block CaramelCake = registerBlock("caramelcake",new CaramelCakeBlockState(FabricBlockSettings.copy(Blocks.CAKE),19,0.1F), UsefulFood.UsefulFood_Group);
